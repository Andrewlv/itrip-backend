...
public class LoginController {
	...
	@ApiOperation(value = "用户登录再登录",httpMethod = "POST",
...
//			@ApiParam(required = true, name = "password", value = "密码",defaultValue="111111")			
	...
	@ApiImplicitParam(paramType="header",required=true,name="token",value="用户认证凭据",
			defaultValue="PC-yao.liu2015@bdqn.cn-8-20170516141821-d4f514")
